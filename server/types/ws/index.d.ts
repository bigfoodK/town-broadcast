// TODO: Classes could not be merged, Find better way
declare module 'ws' {
  ...
  class WebSocket extends events.EventEmitter {
    ...
    constructor(address: string | null, options?: WebSocket.ClientOptions);
    ...
    setSocket(socket: net.Socket, head: Buffer, maxPayload?: number): void;
    terminate(): void;
